...
def execute_benchmark(query_percent, bulkload_percent, method)
  system "./release/benchmark_cache_misses2 \
...
def execute
  ...
  bulkload_percents.each do |bulkload_percent|
    methods.each do |method|
      execute_benchmark(query_percent, bulkload_percent, method)
